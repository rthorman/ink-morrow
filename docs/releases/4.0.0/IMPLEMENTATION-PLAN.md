...
PR 00 merges to **main**. The maintainer then creates **release/4.0.0** from
that merge. PRs 01–18 target the release branch. PR 19 merges the completed,
audited release branch back to main and creates the beta tag.
...
- merge the auditable release branch to main;
...
- release commit equals reviewed integration content;
