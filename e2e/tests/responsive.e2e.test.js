...
const SPECS = [
  ...
  { name: '768x1366 tall tablet portrait', w: 768, h: 1366, coarse: true, art: 'hero-scriptorium-tablet-portrait.webp', portrait: true },
  { name: '800x1280 tablet portrait', w: 800, h: 1280, coarse: true, art: 'hero-scriptorium-tablet-portrait.webp', portrait: true },
  { name: '820x1180 tablet portrait', w: 820, h: 1180, coarse: true, art: 'hero-scriptorium-tablet-portrait.webp', portrait: true },
  { name: '960x1536 android tablet portrait', w: 960, h: 1536, coarse: true, art: 'hero-scriptorium-tablet-portrait.webp', portrait: true },
...
for (const spec of SPECS) {
  test(`responsive: ${spec.name}`, async ({ browser }, testInfo) => {
    ...
    // The prose plane stays opaque, light, and comfortably readable without
    // the retired decorative writing-background layer.
